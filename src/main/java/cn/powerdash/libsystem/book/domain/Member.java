...
public class Member implements java.io.Serializable {
	...
	public Member(int storeId, String name, String credentialsName, int credentialsType, String credentialsNum,
			String address, String telephone, String email, int wxid, int type, String photo, int reward,
			int rewardUsed, Date registerDate, Date validityStartDate, Date validityEndDate) {
